...
const FloatingScreenContext = createContext<FloatingScreenContextType | undefined>(undefined)

export const FloatingScreenProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <FloatingScreenContext.Provider value={{ isScreenOpen, openScreen, closeScreen, toggleScreen, setContent, screenContent }}>
      {children}
...
export const useFloatingScreen = () => {
  ...
  if (!context) {
    throw new Error('useFloatingScreen must be used within a FloatingScreenProvider')
  }
  return context
}
