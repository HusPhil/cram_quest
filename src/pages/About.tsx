export default function About() {
	return (
		<div className="flex w-full h-full flex-col items-center justify-center bg-background px-5 py-12 text-gray-300">
			<div className="w-full max-w-4xl rounded-lg border border-white/10 bg-secondary py-5 px-8 shadow-lg md:p-12 ">
				...
				<p className="mb-6 text-justify text-lg leading-relaxed">
					...
					This is still an early release and your feedbacks are
					important to us as we work to add more features and refine
					the gameplay.
				</p>
				<p>
					Connect with us at{' '}
