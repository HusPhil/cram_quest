  ...
  return (
    ...
    >
      ...
      <div className={`
        ...
        ${variant === 'secondary' ? 'from-gray-500/5' : 
          variant === 'success' ? 'from-green-500/5' :
          variant === 'danger' ? 'from-red-500/5' :
          'from-amber-500/5'} 
      ...
      {glowEffect && (
        <div className={`
          ...
          ${variant === 'secondary' ? 'from-gray-500/0 via-gray-500/10' : 
            variant === 'success' ? 'from-green-500/0 via-green-500/10' :
            variant === 'danger' ? 'from-red-500/0 via-red-500/10' :
