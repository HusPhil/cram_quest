...
export function useBossBattleControls({
  ...
  const handleAttackPhase = (success: boolean, finalPosition: number) => {
    ...
    chainScenes(
      ...
      [
        {
          sceneSteps: success ? playerAttackScene : playerAttackMissScene,
          sceneName: success ? "playerAttackScene" : "playerAttackMissScene",
        ...
        },
        {
          ...
          onLastStepIndex: () => {
            ...
            writeToBattleLog(isEnemyCrit ? "Heavy damage" : "", "fail");
          },
        },
      ],
      () => {
